...
function getContainerByID(id) {
  var container = containerCache[id];
  if (isRemoteContainerReference(container)) {
    return resolveRemoteContainerReference(container);
  }
  return container;
}
 ...
 */
function createContainerID(container) {
  if (isRemoteContainerReference(container)) {
...
function performWithCachedContainer(container, cb) {
  var containerID = createContainerID(container);
